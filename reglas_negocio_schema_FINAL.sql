-- ============================================================================
-- ESQUEMA DE REGLAS DE NEGOCIO - SQL SERVER (VERSIÓN FINAL - CORREGIDO)
...
CREATE TABLE auditoria_evaluacion_reglas (
    ...
    -- DECISIÓN (TIPO CORREGIDO: NVARCHAR(20) en lugar de MAX para índices)
    decision NVARCHAR(20),              -- 'permitida', 'bloqueada', 'requiere_aprobacion', 'condiciones_no_cumplidas'
...
-- ============================================================================
-- 6. TABLA DE HERENCIA - RELACIONES ENTRE REGLAS (CORREGIDA: NO ACTION)
-- ============================================================================
...
CREATE TABLE herencia_reglas (
    ...
    -- CORREGIDO: ON DELETE NO ACTION para evitar ciclos y múltiples cascade paths
...
-- ============================================================================
-- CREAR ÍNDICES (CON TIPOS CORRECTOS)
-- ============================================================================
...
-- AUDITORÍA: decision es NVARCHAR(20) ahora, así que puede ser indexado
...
BEGIN
    ...
    DECLARE @decision NVARCHAR(20) = 'permitida';  -- CORREGIDO: NVARCHAR(20)
...
PRINT '✅ SCHEMA CREADO EXITOSAMENTE - SIN ERRORES';
PRINT '';
PRINT 'Objetos creados:';
PRINT '  - 6 Tablas: reglas_negocio, condiciones_regla, acciones_regla, auditoria_evaluacion_reglas, cache_evaluacion_reglas, herencia_reglas';
PRINT '  - 6 Stored Procedures: sp_crear, sp_evaluar, sp_listar, sp_obtener_auditoria, sp_actualizar, sp_eliminar';
PRINT '  - 3 Vistas: vw_reglas_por_empresa, vw_resumen_auditoria, vw_reglas_activas_por_nivel';
PRINT '  - 10 Índices optimizados';
PRINT '';
PRINT 'Ahora puedes ejecutar: reglas_negocio_ejemplos_FINAL.sql';
